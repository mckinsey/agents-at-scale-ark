...
$(ARK_MCP_STAMP_INSTALL): $(ARK_MCP_STAMP_BUILD)
	...
	@rm -rf $(ARK_MCP_SERVICE_DIR)/ark-mcp/out
	cd $(ARK_MCP_SERVICE_DIR) && helm upgrade --install ark-mcp ./chart -n $(ARK_MCP_NAMESPACE) --create-namespace --set app.image.repository=$(ARK_MCP_IMAGE) --set app.image.tag=$(ARK_MCP_TAG) --set ingress.enabled=true
	@touch $@
