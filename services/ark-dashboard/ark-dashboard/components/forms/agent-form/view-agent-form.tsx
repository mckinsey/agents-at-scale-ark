...
export function ViewAgentForm({
  ...
  const fetchAgentYaml = useCallback(
    async (name: string) => {
      try {
      ...
      formContent={
        <div className="flex flex-col gap-6 px-5 pt-5 pb-6">
          <Form {...form}>
                  ...
                  return (
                    <FieldSet className="gap-2">
                      ...
                      <Select
                        ...
                        value={field.value}
                        disabled={isDisabled}>
                        <SelectTrigger className={inlineFieldTriggerClass}>
            ...
            {!isA2A && (
              <FieldSet className="gap-2">
                ...
                {unavailableTools.length > 0 && (
                  <FieldDescription>
                    These tools are no longer available in this namespace.
            ...
            {isA2A && <SkillsDisplaySection skills={agent?.skills || []} />}
          </Form>
        </div>
      }
