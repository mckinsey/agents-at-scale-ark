...
$(ARK_DASHBOARD_STAMP_TEST): $(ARK_DASHBOARD_STAMP_DEPS) # Run npm audit (non-blocking) and tests
	cd $(ARK_DASHBOARD_SERVICE_SOURCE_DIR) && npm audit --audit-level=critical || true && npm run test -- --coverage
	@touch $@
