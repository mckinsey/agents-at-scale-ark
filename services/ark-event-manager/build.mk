...
$(ARK_EVENT_MANAGER_STAMP_BUILD): $(ARK_EVENT_MANAGER_STAMP_TEST)
	cd $(ARK_EVENT_MANAGER_SERVICE_DIR) && docker build -f $(ARK_EVENT_MANAGER_SERVICE_SOURCE_DIR)/Dockerfile -t $(ARK_EVENT_MANAGER_IMAGE):$(ARK_EVENT_MANAGER_TAG) $(ARK_EVENT_MANAGER_SERVICE_SOURCE_DIR)
	@touch $@
