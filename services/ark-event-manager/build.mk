...
$(ARK_EVENT_MANAGER_STAMP_BUILD): $(ARK_EVENT_MANAGER_STAMP_TEST)
	cd $(ARK_EVENT_MANAGER_SERVICE_DIR) && docker build -f ark-event-manager/Dockerfile -t $(ARK_EVENT_MANAGER_IMAGE):$(ARK_EVENT_MANAGER_TAG) .
	@touch $@
...
$(ARK_EVENT_MANAGER_STAMP_INSTALL): $(ARK_EVENT_MANAGER_STAMP_BUILD) $$(LOCALHOST_GATEWAY_STAMP_INSTALL)
	...
	./scripts/build-and-push.sh -i $(ARK_EVENT_MANAGER_IMAGE) -t $(ARK_EVENT_MANAGER_TAG) -f $(ARK_EVENT_MANAGER_SERVICE_SOURCE_DIR)/Dockerfile -c $(ARK_EVENT_MANAGER_SERVICE_DIR)
