...
DEFAULT_QUERY_TIMEOUT_SECONDS = parse_duration_to_seconds(os.getenv('DEFAULT_QUERY_TIMEOUT', '5m'))
...
async def chat_completions(request: ChatCompletionRequest) -> ChatCompletion:
    ...
    try:
        ...
        async with with_ark_client(namespace, "v1alpha1") as ark_client:
            ...
            # Extract timeout from query spec, falling back to the configured default
            timeout_seconds = parse_duration_to_seconds(query_resource.spec.timeout) or DEFAULT_QUERY_TIMEOUT_SECONDS
