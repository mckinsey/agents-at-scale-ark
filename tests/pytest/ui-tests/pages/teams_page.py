...
class TeamsPage(BasePage):
    ...
    def delete_team_with_verification(self, team_name: str) -> dict:
        ...
        try:
            ...
            row = self.page.get_by_role("row").filter(has_text=team_name).first
            delete_btn = row.get_by_role("button", name="Delete team")
    ...
    def get_team_row_strategy_text(self, team_name: str) -> str:
        try:
            ...
            row = name_el.locator("xpath=ancestor::tr[1]")
