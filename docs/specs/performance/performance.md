...
concurrent workers. Assert zero errors and p99 latency under 500ms
...
|----------|---------|---------|-------------|------------|---------|
| `etcd-baseline-query-creation` | etcd | 100 | 10 | 0 | 500ms |
| `postgresql-baseline-query-creation` | postgresql | 100 | 10 | 0 | 500ms |
