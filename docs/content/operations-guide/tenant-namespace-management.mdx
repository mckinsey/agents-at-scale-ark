...
To open the dashboard for that tenant:

```bash
ark dashboard
```

This port-forwards to the dashboard in your current kubectl context namespace. Add `?namespace=tenant-b` to the URL to view another tenant's resources.
