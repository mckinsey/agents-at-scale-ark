...
| `TEST_PYPI_API_TOKEN` | Secret (Optional) | TestPyPI authentication token for testing Python package deployment | |
| `PYPI_API_TOKEN` | Secret (Optional) | PyPI authentication token with publish permissions for Python SDK deployment | |
