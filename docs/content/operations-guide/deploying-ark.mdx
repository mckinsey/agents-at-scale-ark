...
This builds the containers locally and deploys them to a local cluster. More details are in the [Getting Started](../../quickstart) guide. For more information on local development with live-reload capabilities, see the [Local Development](../developer-guide/local-development) guide. 
