...
```bash
# If you have the code locally, you can use the local chart:
# helm upgrade --install ark-controller ./ark/dist/chart \

# Deploy from registry (recommended)
helm upgrade --install ark-controller oci://ghcr.io/mckinsey/agents-at-scale-ark/charts/ark --version 0.1.31 \
  --namespace ark-system \
  --create-namespace \
