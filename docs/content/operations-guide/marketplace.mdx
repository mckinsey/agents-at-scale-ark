...
kubectl create rolebinding marketplace-source-editor \
  --clusterrole=marketplace-source-editor \
  --group=platform-admins -n team-a
```
...
- [Tenant and Namespace Management](/operations-guide/tenant-namespace-management) — namespace-as-tenant model and cross-tenant RBAC.
