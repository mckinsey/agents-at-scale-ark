...
We recommend using **MicroK8s** for local development.

### MicroK8s Setup

The `ark install` command will automatically detect and configure MicroK8s for you, including enabling necessary add-ons (dns, storage, registry, metrics-server, cert-manager, ingress).

If you prefer to set it up manually or are troubleshooting, you can follow the [MicroK8s documentation](https://microk8s.io/docs).
