...
For a complete working example with step-by-step setup, see [`samples/rag-external-vectordb/`](../../samples/rag-external-vectordb/README.md).
...
A complete working deployment is available in the [samples directory](../../samples/rag-external-vectordb/pgvector/):

- [`secret.yaml`](../../samples/rag-external-vectordb/pgvector/secret.yaml) - Database credentials
- [`pvc.yaml`](../../samples/rag-external-vectordb/pgvector/pvc.yaml) - Persistent storage (10Gi)
- [`configmap.yaml`](../../samples/rag-external-vectordb/pgvector/configmap.yaml) - Init SQL (creates vector extension, documents table, IVFFlat index)
- [`deployment.yaml`](../../samples/rag-external-vectordb/pgvector/deployment.yaml) - PostgreSQL 16 with pgvector
- [`service.yaml`](../../samples/rag-external-vectordb/pgvector/service.yaml) - ClusterIP service
...
The full working retrieval service is in [`samples/rag-external-vectordb/retrieval-service/`](../../samples/rag-external-vectordb/retrieval-service/):

- [`src/rest_server.py`](../../samples/rag-external-vectordb/retrieval-service/src/rest_server.py) - Flask REST API with Azure OpenAI embeddings
- [`Dockerfile`](../../samples/rag-external-vectordb/retrieval-service/Dockerfile) - Container image definition
- [`pyproject.toml`](../../samples/rag-external-vectordb/retrieval-service/pyproject.toml) - Python dependencies
- [`deployment/`](../../samples/rag-external-vectordb/retrieval-service/deployment/) - Kubernetes manifests
...
See the [complete source code](../../samples/rag-external-vectordb/retrieval-service/src/rest_server.py) for implementation details.

**ARK Tool CRDs**:

The three HTTP Tools are defined in [`samples/rag-external-vectordb/tools/`](../../samples/rag-external-vectordb/tools/):

- [`retrieve-chunks.yaml`](../../samples/rag-external-vectordb/tools/retrieve-chunks.yaml) - Main RAG retrieval tool
- [`search-by-metadata.yaml`](../../samples/rag-external-vectordb/tools/search-by-metadata.yaml) - Metadata filtering
- [`get-document-stats.yaml`](../../samples/rag-external-vectordb/tools/get-document-stats.yaml) - Database statistics
...
For complete deployment instructions, see the [Quick Start Guide](../../samples/rag-external-vectordb/README.md#quick-start).
...
A complete working ingestion script is available: [`samples/rag-external-vectordb/ingestion/ingest_sample_data.py`](../../samples/rag-external-vectordb/ingestion/ingest_sample_data.py)
...
A complete RAG-enabled agent example is available: [`samples/rag-external-vectordb/agents/rag-agent.yaml`](../../samples/rag-external-vectordb/agents/rag-agent.yaml)
...
Use the sample query: [`samples/rag-external-vectordb/queries/rag-query.yaml`](../../samples/rag-external-vectordb/queries/rag-query.yaml)
...
1. Follow the [Quick Start Guide](../../samples/rag-external-vectordb/README.md#quick-start) for complete deployment
...
- **[Working Example](../../samples/rag-external-vectordb)**: Production-ready implementation with Azure OpenAI
- **[Sample README](../../samples/rag-external-vectordb/README.md)**: Quick start guide and deployment instructions
