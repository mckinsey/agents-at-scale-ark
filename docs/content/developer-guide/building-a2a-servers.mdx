...
- The [`A2AServer`](TODO) specification has the full details of the `A2AServer` resource
- The [`Agent`](TODO) specification has the full details of the `Agent` resource
