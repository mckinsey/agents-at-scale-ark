...
Ark uses an internal A2A transport mode by default for agent and team execution. `ark.mckinsey.com/execution-mode` is no longer required to enable A2A. See the [A2A Native Execution reference](/reference/a2a-native-execution) for details.
</Callout>
