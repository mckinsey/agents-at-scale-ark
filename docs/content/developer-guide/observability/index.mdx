...
ARK provides observability through OpenTelemetry integration, allowing you to monitor and trace all operations across the controller and services. You can connect to any OpenTelemetry-compatible provider using standard environment variables.
...
Queries flow from the controller to the OTEL endpoint.
