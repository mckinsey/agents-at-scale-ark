...
For the concepts behind this — how the OIDC claim becomes the Kubernetes user and why RBAC RoleBindings must bind that exact identity — see [Identity and impersonation](/core-concepts/identity-and-impersonation).
