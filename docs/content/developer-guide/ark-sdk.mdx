...
# This generates the services/ark-api/openapi.json, based on the FastAPI models.

# Finally, the ark dashboard can have its Typescript types automatically updated
# based on the new ark-api routes and models. Run from ark-dashboard/ark-dashboard:
cp ../../ark-api/openapi.json ../out/
npm run generate:api

# This generates: lib/api/generated/types.ts
```
