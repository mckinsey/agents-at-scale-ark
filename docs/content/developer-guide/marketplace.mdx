...
Practical implication: for a fully-internal marketplace, you need exactly one publicly-fetchable URL — the manifest. Charts can live in your private OCI registry.
