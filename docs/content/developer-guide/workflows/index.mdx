...
2. **The `fark` CLI** — run the pre-built [`ark-tools`](https://github.com/mckinsey/agents-at-scale-ark/blob/main/images/ark-tools/README.md) image and call `fark <agent|team|model|tool> <name> "<message>"`. Shorter for one-shot calls.
