...
The Filesystem MCP Server is available through the [ARK Marketplace](https://mckinsey.github.io/agents-at-scale-marketplace). You can install it using the ARK CLI:
...
For more details, see the [Filesystem MCP Server documentation](https://mckinsey.github.io/agents-at-scale-marketplace/mcps/filesystem-mcp-server/) in the Marketplace.
