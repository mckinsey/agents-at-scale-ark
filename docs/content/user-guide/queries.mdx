...
| **Configuration** | **Timeout** | Default `30m`. Format: `30s`, `5m`, `1h`. |
...
- Timeout exceeded — bump `spec.timeout` (default `30m`); see the [Reference → Timeout](/reference/resources/query#timeout).
