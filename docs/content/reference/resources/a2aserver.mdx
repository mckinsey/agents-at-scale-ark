...
1. **Discovery**: Controller connects to the server and discovers available agents. Tries `/.well-known/agent-card.json` (A2A ≥0.3), then `/.well-known/agent.json` (A2A <0.3).
