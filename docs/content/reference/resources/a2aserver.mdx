...
- `value`: Direct URL
- `valueFrom.serviceRef`: Kubernetes service reference
- `valueFrom.configMapKeyRef`: ConfigMap reference
- `valueFrom.secretKeyRef`: Secret reference
...
| `lastResolvedAddress` | Last successfully resolved server address |
...
1. **Discovery**: Controller connects to the server and discovers available agents
