...
If Kubernetes or Docker cannot be run in your environment, the best solution would be to run a remote Kuberenetes cluster, on AWS/GCP or similar. Check the [Operations Guide](../operations-guide/deploying-ark) on how to do this.
