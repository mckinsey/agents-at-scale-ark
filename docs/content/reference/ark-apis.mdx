...
Queries are the primary way to interact with Ark resources. Use the `/v1/queries/` endpoint to create queries with string input and an optional `conversationId` for multi-turn conversations.
