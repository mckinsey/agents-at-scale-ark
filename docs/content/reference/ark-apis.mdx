...
| Data | Endpoints |
|------|-----------|
| Chunks | `GET /v1/broker/chunks` |
| Events | `GET /v1/broker/events`, `GET /v1/broker/events/{query_id}` |
| Messages | `GET /v1/broker/messages` |
| Sessions | `GET /v1/broker/sessions`, `GET /v1/broker/sessions/{id}` |
| Traces | `GET /v1/broker/traces`, `GET /v1/broker/traces/{id}` |
