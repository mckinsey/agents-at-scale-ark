...
### Evaluations Removed from Core

Evaluation and Evaluator resources have been removed from Ark core and will move to the [marketplace](https://github.com/mckinsey/agents-at-scale-marketplace).

After upgrading, existing Evaluation and Evaluator resources will remain in your cluster but are no longer reconciled. To clean up:
